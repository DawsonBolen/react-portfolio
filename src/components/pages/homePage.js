...
const styles = {
    homePic: {
        backgroundImage: 'url("images/Homelargeheaderpicture.png")',
    ...
    return (
        <main className="main-home">
            ...
            <section id="whatido">
                ...
                <div id="cards">
                    <div className="card">
                        <img src="images/Webdevicon.png" width="44px" height="34px" alt="desktop computer icon"></img>
                    ...
                    <div className="card">
                        <img src="images/graphicdesignicon.png" width="44px" height="28px" alt="paintbrush and pen icon"></img>
                    ...
                    <div className="card">
                        <img src="images/uxdesignicon.png" width="55px" height="33px"
