...
export default function DrinkCampaignGrid() {
    return (
        <div id="drink-campaign-main">
            <div className="drink-card" id="photo1">
            ...
            <div className="drink-card" id="photo7">
            ...
            <div className="drink-card" id="photo8">
            ...
            <div className="drink-card" id="photo9">
